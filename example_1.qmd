...
A version of the [pbmc3k tutorial](https://satijalab.org/seurat/articles/pbmc3k_tutorial "pbmc3k tutorial") form the Satija Lab, together with my own notes, code changes and extensions. The tutorial was re-coded in Quarto, ran on a laptop and published to my github. The focus is on software and data understanding whilst producing the same results. In following example(s), I plan to adjust some parameters to look at the stability of the result with respect to these.
...
file_path <- "./seurat_object_checkpoints/pbmc_sw1.rds"
...
```{r}
file_path <- "./seurat_object_checkpoints/pbmc_sw1_final.rds"
saveRDS_overwrite(file_path)
```
