...
A stripped down version of Example #1, modified to allow key parameters to be 
easily changed in order to look at the stability of the final results.
...
-   The number of Principal Components (PCs) used in clustering is generated
    as a series: 2, 3, 5, 7 and is compared to 10
